  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <div className="px-4 mt-2">
        ...
        {/* Location Button */}
        <button className="w-full border border-black rounded-lg py-3 flex items-center justify-center gap-2 mb-8 hover:bg-gray-50 transition-colors">
          <MapPin size={18} className="text-black" />
          <span className="text-sm font-bold text-black">Usar minha localização atual</span>
        </button>
        
        {/* Restaurant List (Optional Placeholder based on design context) */}
        <div className="flex flex-col gap-6">
          {/* Item 1 */}
          <div className="flex justify-between items-start border-b border-gray-50 pb-4">
            <div>
              <p className="text-xs font-bold text-gray-600 uppercase mb-1">AV. PAULISTA, 1811</p>
              <p className="text-xs text-gray-400 mb-2">Bela Vista . São Paulo . SP</p>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 rounded-full bg-green-500"></div>
                <span className="text-[10px] text-gray-500">Aberto agora</span>
              </div>
            </div>
            <span className="text-xs font-bold text-gray-400">2 KM</span>
          </div>
          
          {/* Item 2 */}
          <div className="flex justify-between items-start border-b border-gray-50 pb-4">
            <div>
              <p className="text-xs font-bold text-gray-600 uppercase mb-1">RUA AUGUSTA, 1029</p>
              <p className="text-xs text-gray-400 mb-2">Consolação . São Paulo . SP</p>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 rounded-full bg-green-500"></div>
                <span className="text-[10px] text-gray-500">Aberto agora</span>
              </div>
            </div>
            <span className="text-xs font-bold text-gray-400">2.4 KM</span>
          </div>
        </div>
      </div>
    </div>
